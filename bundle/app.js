	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(_grid2.default, { container: this.props.grid.container });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grid = function (_React$Component) {
		...
		_createClass(Grid, [{
			key: 'render',
			value: function render() {
				var size = this.props.container.length;
				var containers = this.props.container.map(function (container) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slot = __webpack_require__(171);
	...
	var Container = function (_React$Component) {
		...
		_createClass(Container, [{
			key: 'render',
			value: function render() {
				var classname = "grid-container " + this.props.type;
				var slots = this.props.slots.map(function (slot, index) {
					return _react2.default.createElement(_slot2.default, _extends({
						key: index
					}, slot));
				});
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ 'class': 'grid-container-controls' },
						_react2.default.createElement(
							'span',
							{ 'class': 'grid-container-title' },
							this.props.title
						),
						_react2.default.createElement(
							'div',
							{ 'class': 'grid-container-options' },
							_react2.default.createElement(
								'span',
								{ 'class': 'grid-container-options-icon' },
								'Options ',
								_react2.default.createElement('i', { 'class': 'icon-options' })
							),
							_react2.default.createElement(
								'ul',
								{ 'class': 'grid-container-options-list' },
								_react2.default.createElement(
									'li',
									{ 'class': 'grid-container-options-list-item', role: 'edit' },
									_react2.default.createElement('i', { 'class': 'icon-edit' }),
									' Edit'
								),
								_react2.default.createElement(
									'li',
									{ 'class': 'grid-container-options-list-item', role: 'reuse' },
									_react2.default.createElement('i', { 'class': 'icon-reuse' }),
									' Reuse'
								),
								_react2.default.createElement(
									'li',
									{ 'class': 'grid-container-options-list-item', role: 'toggleslotstyles' },
									_react2.default.createElement('i', { 'class': 'icon-style' }),
									' Slot-styles'
								),
								_react2.default.createElement(
									'li',
									{ 'class': 'grid-container-options-list-item', role: 'trash' },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ 'class': 'grid-container-before' },
							_react2.default.createElement(
								'div',
								{ 'class': 'grid-container-prolog' },
								'PROLOG'
							)
						),
						_react2.default.createElement(
							'div',
							{ 'class': 'grid-slots-wrapper' },
							' ',
							slots,
							' '
						),
		...
		_createClass(Slot, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('div', { 'class': 'grid-slot-style-changer style-changer' }),
					_react2.default.createElement(
						'div',
						{ 'class': 'grid-boxes-wrapper boxes-wrapper' },
						boxes
					)
				);
			}
