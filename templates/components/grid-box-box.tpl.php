...
<div class="<?php echo implode( ' ', $classes); ?>">
  <?php if (!empty($this->title)): ?>
    <?php if (!empty($this->titleurl)): ?>
      <h2 class="grid-box-title b-title"><a class="grid-box-title-link grid-box-title-text" href="<?php echo $this->titleurl; ?>"<?php echo $titleUrlTarget ?>><?php echo $this->title; ?></a></h2>
    <?php else: ?>
  ...
  <?php if (!empty($this->readmore)): ?>
    <a href="<?php echo $this->readmoreurl; ?>" class="grid-box-readmore-link b-readmore-link"<?php echo $readmoreUrlTarget ?>><?php echo $this->readmore; ?></a>
  <?php endif; ?>
</div>
